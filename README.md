...
1) simple run for paired-end sequences
   example: RNA_seq_to_TPM_Bowtie2 -seq_folder RNA-seq_data -ref_seq CDS_seq.fa -build_index 2

2) skip AdapterRemoval and run all the rest of the steps: use all options
   example: RNA_seq_to_TPM_Bowtie2 -skip_filtering 2 -build_index 2 -seq_folder RNA-seq_data -ref_seq CDS_seq.fa
            
3) skip build index and run all the rest of the steps: set '-build_index' option as '2' and use all options
   example: RNA_seq_to_TPM_Bowtie2 -build_index 1 -seq_folder RNA-seq_data -ref_seq CDS_seq.fa

4) only parse RSEM results: set '-parsing_only' option as '2'
   example: RNA_seq_to_TPM_Bowtie2 -seq_folder RNA-seq_data -parsing_only 2 
